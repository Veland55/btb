...
const equipmentByFaction = {
  ...
  "Joker": [
    ...
    { name: "Fireworks", fundingCost: 300, repCost: 0, maxPerCrew: 2, conditions: [], effects: ["Model gains the Flare rule."] },
  ...
  "Penguin": [
    ...
    { name: "Neurotoxic Drugs - Iceberg Lounge", fundingCost: 500, repCost: 0, maxPerCrew: 1, conditions: [], group: "Iceberg Lounge", effects: ["+2 Movement and Dodge trait."] },
    { name: "Silencer - Iceberg Lounge", fundingCost: 400, repCost: 0, maxPerCrew: 1, conditions: [], group: "Iceberg Lounge", effects: ["One ranged weapon gains Silencer trait."] },
    { name: "Weird Ammo - Iceberg Lounge", fundingCost: 300, repCost: 0, maxPerCrew: 1, conditions: [], group: "Iceberg Lounge", effects: ["Ranged attacks gain Enervating 2 or Anti-tank."] },
    { name: "Mutation Serum - Iceberg Lounge", fundingCost: 500, repCost: 0, maxPerCrew: 1, conditions: [], group: "Iceberg Lounge", effects: ["Model gains Tough Skin and Desensitized trait."] },
    { name: "Fear Gas Dispenser - Iceberg Lounge", fundingCost: 600, repCost: 0, maxPerCrew: 1, conditions: [], group: "Iceberg Lounge", effects: ["Model gains the Inspire Fear trait."] },
    { name: "Titan Dose - Iceberg Lounge", fundingCost: 300, repCost: 0, maxPerCrew: 1, conditions: [], group: "Iceberg Lounge", effects: ["Model gains one Titan Dose."] },
    { name: "Prototype Freeze Ray - Iceberg Lounge", fundingCost: 500, repCost: 0, maxPerCrew: 1, conditions: [], group: "Iceberg Lounge", effects: ["Model gains the Ice Flash trait."] }
  ],
  "Bane": [
    { name: "Magazine", fundingCost: 200, repCost: 0, maxPerCrew: 2, conditions: [], effects: ["+1 to Ammunition for one weapon."] },
    { name: "Grapple Gun", fundingCost: 300, repCost: 0, maxPerCrew: 2, conditions: [], effects: ["Model gains the Batclaw/Grapple Gun rule."] },
  ...
  "Court of Owls": [
    ...
    { name: "C-4", fundingCost: 300, repCost: 0, maxPerCrew: 1, conditions: ["Only Henchman/Free Agents"], effects: ["Model gains the Explosive Gel rule."] },
    ...
    { name: "Circus Gromming", fundingCost: 100, repCost: 0, maxPerCrew: 1, conditions: ["Only Henchman/Free Agents"], effects: ["Model gains Combat Flip rule."] },
  ...
  "The Riddler": [
    ...
    { name: "Broken Equipment", fundingCost: 250, repCost: 0, maxPerCrew: 1, conditions: [], effects: ["Disables one enemy equipment pre-game."] },
    ...
    { name: "Its a Dud", fundingCost: 100, repCost: 0, maxPerCrew: 1, conditions: ["Quelle"], effects: ["Remove 1 Riddle marker at activation start."] },
    ...
    { name: "B.U.C. (Bots Upgraded CPU)", fundingCost: 100, repCost: 0, maxPerCrew: 1, conditions: ["The Riddler (Arkham Knight)"], targetModels: ["The Riddler (Arkham Knight)"], effects: ["The Can you solve this? (X) trait allows you to place 8 Clue markers instead of 5."] },
  ...
  "Mr. Freeze": [
    ...
    { name: "Queen's Choosen", fundingCost: 200, repCost: 0, maxPerCrew: 1, conditions: ["Killer Frost"], effects: ["Model gains the Bodyguard rule."] },
  ...
  "League of Shadows": [
    ...
    { name: "Combat Braces", fundingCost: 150, repCost: 0, maxPerCrew: 2, conditions: [], effects: ["Close combat weapons gain Defensive."] },
  ...
  "Birds of Prey": [
    ...
    { name: "Adaptive Planning", fundingCost: 200, repCost: 2, maxPerCrew: 2, conditions: ["Model has Plant trait cannot purchase"], effects: ["Model gains the Adaptable trait."] },
  ...
  "Organized Crime": [
    ...
    { name: "C-4", fundingCost: 250, repCost: 0, maxPerCrew: 1, conditions: [], effects: ["Model gains the Explosive Gel trait."] },
    ...
    { name: "Acid Coating", fundingCost: 150, repCost: 0, maxPerCrew: 2, conditions: [], effects: ["Model's Close Combat attacks gain Acid."] },
    { name: "Bulletproof Vest", fundingCost: 150, repCost: 0, maxPerCrew: 2, conditions: [], effects: ["Model gains the Bulletproof Vest rule."] },
    { name: "Brass Knuckles", fundingCost: 100, repCost: 0, maxPerCrew: 2, conditions: [], effects: ["Model gains the Reinforced Gloves trait."] },
    { name: "The Cleaner", fundingCost: 100, repCost: 0, maxPerCrew: 100, conditions: [], effects: ["Draw 1 Objective card on revealing enemy Suspect."] },
