...
const traitDescriptions = {
  ...
  "Get 'Em": "One friendly model within 8\" and line of sight of this model gains +2 ★.",
  ...
  "Heroic": "This model gains +1 to Attack, Defense and Willpower while there is at least one other friendly model in play with this trait.",
  "Hidden": "This model may move up to 2 markers within 8\" up to 4\".",
  "Hidden Boss": "This model may move up to 2 markers within 8\" up to 4\".",
  ...
  "Kill Them!": "Target a friendly model with Rank Henchman within 4\" of this model (but not the activated model itself). Target model gains +2 ★.",
  ...
  "Lieutenant (X)": "If the crew contain a model with Alias (X), this model reduces its funding cost to 0 and all friendly models with Rank Henchman that start their activation within 8'' of this model are affected by the Inspire trait of the friendly model with Alias: (X).",
  ...
  "Pyromania (Mental Disorder)": "If this model can see any model that suffers the Fire Status, this model gains a ☽.",
  ...
  "Speed Force Master": "This model can spend up to 2 Speed Power counters during the round like Action Counters. This model can spend up to 2 Speed Power markers during its activation to gain up to 2 ★ or ♣.",
