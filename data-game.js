...
// Источники: официальные PDF Knight Models
//   Event cards v02 — Nov 2023  (16 карт)
//   Encounter cards v02 — Nov 2023  (16 карт)
// Тексты приведены дословно на языке оригинала. Для Encounter-карт поле dz —
// краткое словесное описание зон расстановки; точная схема — на печатной карте.
// Токены {..._ICON} рендерятся в иконки через replaceIcons() из script.js.
// ==================================================================
