...
const translations = {
  ru: {
    ...
    obj_card_forbidden: "Карта «{name}» запрещена правилами вашего отряда — её нельзя включить в колоду",
    ...
    game_score_short: "VP",
    game_score_hint: "Очки побед (VP) набираются картами целей ниже. Счётчики локальные на каждом устройстве.",
    game_finish_hint: "Отметьте победителя — итог увидят оба игрока, а победа попадёт в рейтинг статистики.",
    game_finish: "ЗАВЕРШИТЬ ИГРУ",
    game_finish_cancel: "Отмена",
    game_tab_cards: "Цели и счёт",
    game_tab_me: "Мой ростер",
    game_tab_opp: "Оппонент",
    game_chip_ev: "СОБ",
    game_chip_en: "СТЛ",
    ...
    game_round: "РАУНД",
    game_round_short: "Р",
    game_initiative_short: "Иниц.",
    game_pass_short: "Пасс",
    game_next_round: "НОВЫЙ РАУНД",
    game_confirm_next_round: "Начать новый раунд? Отметки Audacity (AUD) будут сняты, пасс-маркеры сброшены, статусы «до конца раунда» удалены, Resource Points вернутся к 3, колода целей перетасуется.",
  ...
  en: {
    ...
    obj_card_forbidden: "\"{name}\" is forbidden by your crew's rules — it cannot be included in the deck",
    ...
    game_score_short: "VP",
    game_score_hint: "Victory points (VP) are earned with the Objective cards below. Counters are local to each device.",
    game_finish_hint: "Mark the winner — both players will see the result, and the win goes to the statistics rating.",
    game_finish: "FINISH THE GAME",
    game_finish_cancel: "Cancel",
    game_tab_cards: "Objectives & score",
    game_tab_me: "My roster",
    game_tab_opp: "Opponent",
    game_chip_ev: "EV",
    game_chip_en: "EN",
    ...
    game_round: "ROUND",
    game_round_short: "R",
    game_initiative_short: "Init.",
    game_pass_short: "Pass",
    game_next_round: "NEW ROUND",
    game_confirm_next_round: "Start a new round? Audacity (AUD) marks will be cleared, Pass markers reset, end-of-round statuses removed, Resource Points restored to 3 and the Objective deck reshuffled.",
